...
const projects = ref([
  {
    id: 1,
    name: "PROJECT AQUA",
    description: "Purificação de água em massa para o deserto da Capital. Requer atualizações frequentes no reator principal.",
    image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=300&q=80"
  },
  {
    id: 2,
    name: "G.E.C.K. INIT",
    description: "Kit de Criação do Jardim do Éden. Dispositivo capaz de colapsar matéria e reorganizá-la em terra fértil habitável.",
    image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=300&q=80"
  },
  {
    id: 3,
    name: "LIBERTY PRIME",
    description: "Restauração do sistema tático de combate robótico gigante. Armamento pesado e diretrizes de democracia forçada.",
